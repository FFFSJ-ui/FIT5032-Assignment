...
function showPlace(place) {
  ...
  marker = new mapboxgl.Marker({ color: 'blue' }).setLngLat(place.center).addTo(map)
  // Display information pop-up window
  new mapboxgl.Popup().setLngLat(place.center).setHTML(`<h6>${place.place_name}</h6>`).addTo(map)
